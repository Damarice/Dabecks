    ...
    <div>
      ...
      <section className="ds-section" style={{ background: 'var(--color-surface)' }}>
        <div className="ds-container">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(clamp(280px, 90vw, 300px), 1fr))', gap: '1px', background: 'var(--color-border)' }}>
      ...
      <section className="ds-section" style={{ background: '#ffffff' }}>
        <div className="ds-container">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(clamp(220px, 90vw, 240px), 1fr))', border: '1px solid var(--color-border)' }}>
