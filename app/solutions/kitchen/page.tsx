  ...
  return (
    <CategoryLandingPage
      ...
      featured={[
        ...
        { title: 'Cooking Ranges', desc: 'Professional gas and electric ranges built for the demands of high-volume kitchen service.', image: '/kitchen-categories/cooking-ranges.webp', href: '/solutions/kitchen/cooking-ranges' },
      ]}
      categories={[
