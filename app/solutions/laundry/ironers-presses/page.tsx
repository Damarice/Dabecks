...
export default function IronersPresses() {
  return (
    <SubpageListingPage
      ...
      products={[
        { model: 'IB5725', desc: 'Flatwork ironer · Rear delivery', slug: 'ib5725', placeholder: 'IB5725', image: '/products/ironers/ib5725.jpg' },
        { model: 'IB5725-F', desc: 'Flatwork ironer · Rear delivery with integrated feeder', slug: 'ib5725-f', placeholder: 'IB5725-F', image: '/products/ironers/ib5725-f.jpg' },
        { model: 'IC64819R', desc: 'Cylinder ironer Ø480mm · Rear delivery', slug: 'ic64819r', placeholder: 'IC64819R', image: '/products/ironers/ic64819r.jpg' },
        { model: 'IC64819LF', desc: 'Cylinder ironer Ø480mm · Length folding', slug: 'ic64819lf', placeholder: 'IC64819LF', image: '/products/ironers/ic64819lf.jpg' },
        { model: 'IC64819FLF', desc: 'Cylinder ironer Ø480mm · Feeding & length folding', slug: 'ic64819flf', placeholder: 'IC64819FLF', image: '/products/ironers/ic64819flf.jpg' },
        { model: 'Line 6000 FFS', desc: 'Cylinder ironer · Feeding, folding & stacking', slug: 'line6000-ffs', placeholder: 'Line 6000 FFS', image: '/products/ironers/ironer-ffs.jpg' },
      ]}
