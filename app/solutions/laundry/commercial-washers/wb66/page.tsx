      ...
      <section className="bg-gradient-to-r from-gray-50 to-blue-50 py-20">
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <h1 className="text-6xl md:text-7xl font-black text-[#1a3a8f] mb-6">WB6-6</h1>
              <p className="text-3xl md:text-4xl text-gray-700 mb-8 font-medium">Front Load Washer - 6kg Capacity</p>
              
              <div className="space-y-6 mb-10">
                <div>
                  <p className="text-[#00b4d8] font-bold text-2xl uppercase tracking-wide mb-2">Load Capacity</p>
                  <p className="text-3xl text-gray-800 font-semibold">6 kg</p>
                </div>
                <div>
      ...
      <section className="max-w-7xl mx-auto px-4 md:px-6 py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          {[
            ...
            { title: 'High Performance', desc: 'Designed for high-volume laundry operations' },
            { title: 'Easy Operation', desc: 'Intuitive control system' },
            { title: 'Durable Construction', desc: 'Premium stainless steel build' },
