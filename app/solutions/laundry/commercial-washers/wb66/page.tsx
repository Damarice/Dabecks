      ...
      <section className="bg-white py-16 md:py-24 border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          <div className="mb-12">
            ...
            <h1 className="text-5xl md:text-7xl font-black text-[#1a3a8f] mb-6">WB6-6</h1>
            <p className="text-2xl md:text-3xl text-gray-700 font-medium max-w-2xl">Front-load washer with 6kg load capacity. Compact yet powerful for commercial use.</p>
          </div>

          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div className="flex items-center justify-center bg-gray-50 rounded-lg p-8 h-96 lg:h-full min-h-96">
              <img src="https://via.placeholder.com/400x350?text=WB6-6" alt="WB6-6" className="max-h-full max-w-full object-contain" />
            </div>
            ...
            <div className="flex flex-col justify-center">
              <div className="space-y-8">
                <div>
                  ...
                  <p className="text-4xl md:text-5xl font-black text-[#1a3a8f]">6 kg</p>
                </div>
                <div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          <div className="lg:col-span-2">
            ...
            <div className="space-y-6 text-xl text-gray-700 leading-relaxed">
              <p>The WB6-6 is a compact yet powerful front-load washer designed for commercial laundry operations. Perfect for facilities with moderate to high volume requirements.</p>
              <p>With advanced technology and energy-efficient operation, it delivers professional-grade results while maintaining operational cost efficiency.</p>
            </div>
          </div>
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-xl font-semibold text-[#1a3a8f]">WB6-6</p>
              </div>
              <div>
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              { label: 'Water Usage', value: '40 L/cycle' },
