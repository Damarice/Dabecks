    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="flex items-center justify-center bg-white rounded-lg p-8 h-96">
              <img src="https://via.placeholder.com/400x350?text=Primus+FX55" alt="Primus FX55" className="max-h-full max-w-full object-contain" />
            </div>

            <div>
              <h1 className="text-6xl md:text-7xl font-black text-[#1a3a8f] mb-6">Primus FX55</h1>
              <p className="text-3xl md:text-4xl text-gray-700 mb-8 font-medium">Front Load Industrial Washer</p>
              
              <div className="space-y-6 mb-10">
                <div>
                  <p className="text-[#00b4d8] font-bold text-2xl uppercase tracking-wide mb-2">Load Capacity</p>
                  <p className="text-3xl text-gray-800 font-semibold">55 lbs (25 kg)</p>
                </div>
                <div>
                  <p className="text-[#00b4d8] font-bold text-2xl uppercase tracking-wide mb-2">Spin Speed</p>
                  <p className="text-3xl text-gray-800 font-semibold">1000 RPM</p>
                </div>
                <div>
      ...
      <section className="max-w-7xl mx-auto px-4 md:px-6 py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          {[
            { title: 'Industrial Grade', desc: 'Built tough for heavy daily use' },
            { title: 'Reliable Performance', desc: 'Consistent results across all wash cycles' },
            { title: 'Easy Controls', desc: 'Straightforward operation for all staff' },
            { title: 'Robust Construction', desc: 'Heavy-duty materials for durability' },
            { title: 'Low Downtime', desc: 'Minimal maintenance requirements' },
            { title: 'Cost Effective', desc: 'Great value for commercial operations' },
          ].map((f, i) => (
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              { label: 'Dimensions', value: '700 x 950 x 1000 mm' },
