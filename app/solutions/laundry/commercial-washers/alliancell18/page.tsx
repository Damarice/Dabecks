    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-r from-gray-50 to-blue-50 py-20">
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <h1 className="text-6xl md:text-7xl font-black text-[#1a3a8f] mb-6">Alliance L18</h1>
              <p className="text-3xl md:text-4xl text-gray-700 mb-8 font-medium">Commercial Washer - 18kg Capacity</p>
              
              <div className="space-y-6 mb-10">
                <div>
                  <p className="text-[#00b4d8] font-bold text-2xl uppercase tracking-wide mb-2">Load Capacity</p>
                  <p className="text-3xl text-gray-800 font-semibold">18 kg</p>
                </div>
                <div>
      ...
      <section className="max-w-7xl mx-auto px-4 md:px-6 py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          {[
            { title: 'High Capacity', desc: '18kg load capacity for larger operations' },
            { title: 'Reliable Performance', desc: 'Built for commercial use with consistent results' },
            { title: 'Simple Controls', desc: 'User-friendly interface for daily operations' },
            { title: 'Strong Build', desc: 'Heavy-duty construction for long-term use' },
            { title: 'Easy Service', desc: 'Accessible components for routine maintenance' },
            { title: 'Industry Proven', desc: 'Trusted by commercial laundries worldwide' },
          ].map((f, i) => (
