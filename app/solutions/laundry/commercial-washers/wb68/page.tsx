    ...
    <div className="min-h-screen bg-white">
            ...
            <div>
              ...
              <div className="space-y-6 mb-10">
                ...
                <div>
                  ...
                  <p className="text-3xl text-gray-800 font-semibold">1400 RPM</p>
                </div>

                <div>
                  <p className="text-[#00b4d8] font-bold text-2xl uppercase tracking-wide mb-2">Energy Rating</p>
                  <p className="text-3xl text-gray-800 font-semibold">A+++</p>
                </div>
              </div>

              <Link 
                href="/contact" 
                className="bg-[#00b4d8] text-[#1a3a8f] font-bold py-4 px-10 rounded text-2xl uppercase tracking-wide hover:bg-[#00a0b8] transition-colors inline-block"
              >
          ...
          {[
            {
              ...
              desc: 'Reduces operational expenditure by up to 40% with built-in water and energy optimization technologies'
            },
            {
              title: 'High Performance',
              desc: 'Designed for high-volume laundry operations with consistent, professional washing results'
            },
            {
              title: 'Easy Operation',
              desc: 'Intuitive control system requires minimal training for operators'
            },
            {
              title: 'Durable Construction',
              desc: 'Premium stainless steel drum and body built to last for years of continuous use'
            },
            {
              title: 'Quick Maintenance',
              desc: 'Easy access to all components for fast and efficient maintenance'
            },
            {
              title: 'Certified Quality',
              desc: 'Meets international commercial laundry standards and certifications'
            },
          ].map((feature, i) => (
            <div key={i} className="border-l-4 border-[#00b4d8] pl-6">
              <h3 className="text-3xl font-bold text-[#1a3a8f] mb-3">{feature.title}</h3>
              <p className="text-2xl text-gray-700">{feature.desc}</p>
            </div>
          ))}
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="bg-white rounded-lg p-8 shadow-md">
                ...
                <p className="text-4xl font-black text-[#1a3a8f]">{spec.value}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="bg-[#1a3a8f] text-white py-16">
        <div className="max-w-4xl mx-auto text-center px-6">
          ...
          <p className="text-2xl mb-10 opacity-90">Get a detailed quote and expert consultation for your facility</p>
